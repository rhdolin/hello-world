...
def populatePolygenicPopulationStatistics():
    with open('data/polygenicPopulationStatistics.csv') as polygenicPopulationStatisticsFile:
...
with st.sidebar:
    ...
    st.image("data/normalDistribution.png",width=300)
...
if st.sidebar.button("Run"):
    ...
    with st.expander("Polygenic Score Model"):
        polygenicModelFile = "data/" + polygenicModelID + ".txt"
        polygenicModel = open("data/"+ polygenicModelID + ".txt","r")
        fileContents=""
